...
export class ProductService {
  private productsSubject = new BehaviorSubject<Product[]>([
    ...
    },
    {
      ...
      price: 199.99,
      imageUrl: 'assets/images/bag3/img1.jpg',
      category: 'handbags',
      rating: 4.5,
      description: 'Clean and minimal design tote bag for everyday use',
      images: [
        'assets/images/bag3/img1.jpg',
    ...
    },
    {
      ...
      price: 149.99,
      imageUrl: 'assets/images/bag2/img1.jpg',
      category: 'handbags',
      rating: 4.6,
      description: 'Stylish round crossbody bag with adjustable strap',
      images: [
        'assets/images/bag2/img1.jpg',
    ...
    },
    {
      ...
      price: 179.99,
      imageUrl: 'assets/images/bag1/img1.jpg',
      category: 'handbags',
      rating: 4.7,
      description: 'Premium designer clutch for special occasions',
      images: [
        'assets/images/bag1/img1.jpg',
    ...
    },
    {
      ...
      name: 'Weekend Tote',
      price: 129.99,
      imageUrl: 'assets/images/bag-g/img1.jpg',
      category: 'handbags',
      rating: 4.4,
