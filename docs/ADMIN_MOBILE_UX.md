...
| **M6** | Page leftovers + Sections mode UX | ✅ Done | Fullscreen Architect overlay, compact cards, FAB Preview |
...
```
fix(admin-mobile): polish section architect UX with fullscreen preview and compact cards (Phase M6)

Replace stacked mobile Architect with a fullscreen overlay and FAB; simplify section list into compact cards with overflow actions.
```
