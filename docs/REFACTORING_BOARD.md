...
|---|---------|----------------------|--------|------|----------|
| M1 | Hardcoded hex в SCSS (вне tokens/themes) | 1 336 в 68 файлах | **~614** в 55 файлах | 0 | ▓▓▓▓▓░░░░░ ~54% |
...
| M5 | Компоненты полностью на semantic-токенах (без hex) | 3 / 86 | **15 / 86** | 86 / 86 | ▓▓░░░░░░░░ 17% |
...
| D | Миграция компонентов (ADR-006) | 🔄 In Progress | 4/10 | M1, M5 |
...
**Прогресс**: полностью чистых 15/86 (+header, +footer, +hero, +hero-glass, +best-sellers), частично ~17.
