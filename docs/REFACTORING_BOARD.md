...
|---|---------|----------------------|--------|------|----------|
| M1 | Hardcoded hex в SCSS (вне tokens/themes) | 1 336 в 68 файлах | **761** в 60 файлах | 0 | ▓▓▓▓░░░░░░ ~43% |
...
| M5 | Компоненты полностью на semantic-токенах (без hex) | 3 / 86 | **10 / 86** | 86 / 86 | ▓▓░░░░░░░░ 12% |
...
| D | Миграция компонентов (ADR-006) | 🔄 In Progress | 3/10 | M1, M5 |
...
**Прогресс**: полностью чистых 10/86 (+bought-together, +similar-products), частично ~22.
