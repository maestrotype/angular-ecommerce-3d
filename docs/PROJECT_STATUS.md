...
| H7 | Admin UX Polish | 🔄 In Progress | **Page Sections device preview + drag & drop fix** — see [task_003](tasks/task_003_page_sections_device_preview_dnd.md) |
...
| Date | Change | Author |
|------|--------|--------|
| 2026-08-09 | **Epic H7 started — Task 003**: Page Sections device emulator fix (mobile/fold frames use correct bounded height) + CDK drag-drop UX improvements (custom preview badge, styled placeholder). See [task_003](tasks/task_003_page_sections_device_preview_dnd.md). | Implementation Engineer |
